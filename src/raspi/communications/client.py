...
class Client():
    ...
    def __init__(self, broker_addr='localhost', broker_port=8883, ca_cert='communications/certs/ca.crt', client_cert='communications/certs/client.crt', client_key='communications/certs/client.key', tls=True):
